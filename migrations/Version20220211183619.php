 ...
 */
final class Version20220211183619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT AUTO_INCREMENT NOT NULL, question_id INT NOT NULL, test_id INT NOT NULL, answer VARCHAR(128) DEFAULT NULL, INDEX IDX_DADD4A251E27F6BF (question_id), INDEX IDX_DADD4A251E5D0459 (test_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE test (id INT AUTO_INCREMENT NOT NULL, exam_id INT NOT NULL, user_id INT NOT NULL, status VARCHAR(128) NOT NULL, date DATE DEFAULT NULL, attended TINYINT(1) DEFAULT NULL, INDEX IDX_D87F7E0C578D5E91 (exam_id), INDEX IDX_D87F7E0CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE answer ADD CONSTRAINT FK_DADD4A251E27F6BF FOREIGN KEY (question_id) REFERENCES question (id)');
        $this->addSql('ALTER TABLE answer ADD CONSTRAINT FK_DADD4A251E5D0459 FOREIGN KEY (test_id) REFERENCES test (id)');
